CREATE TYPE "public"."notification_type" AS ENUM('task_assigned', 'task_completed', 'project_update', 'mention', 'system');--> statement-breakpoint
...
CREATE TYPE "public"."task_status" AS ENUM('todo', 'in_progress', 'in_review', 'completed');--> statement-breakpoint
